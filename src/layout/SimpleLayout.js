    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start rtl:justify-end">
        ...
        <Link to="/" className="flex ms-2 md:me-24">
          <img src={Logo} className="h-8 me-3" alt="Data Investigo Logo" />
          {/* <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Data Investigo</span> */}
        </Link>
      </div>
